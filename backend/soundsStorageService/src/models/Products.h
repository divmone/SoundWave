...
class Products
{
  public:
    struct Cols
    {
        ...
        static const std::string _sound_id;
    ...
    const int64_t &getValueOfDownloadCount() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<int64_t> &getDownloadCount() const noexcept;
    ///Set the value of the column download_count
    void setDownloadCount(const int64_t &pDownloadCount) noexcept;
    void setDownloadCountToNull() noexcept;
  ...
  private:
    ...
    std::shared_ptr<int64_t> downloadCount_;
