...
class Sounds
{
  public:
     ...
     */
    explicit Sounds(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit Sounds(const Json::Value &pJson) noexcept(false);
     ...
     */
    Sounds(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
  ...
  private:
    friend drogon::orm::Mapper<Sounds>;
    friend drogon::orm::BaseBuilder<Sounds, true, true>;
    friend drogon::orm::BaseBuilder<Sounds, true, false>;
    friend drogon::orm::BaseBuilder<Sounds, false, true>;
    friend drogon::orm::BaseBuilder<Sounds, false, false>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<Sounds>;
#endif
