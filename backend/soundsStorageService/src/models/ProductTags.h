...
class ProductTags
{
  public:
     ...
     */
    explicit ProductTags(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit ProductTags(const Json::Value &pJson) noexcept(false);
     ...
     */
    ProductTags(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
  ...
  private:
    friend drogon::orm::Mapper<ProductTags>;
    friend drogon::orm::BaseBuilder<ProductTags, true, true>;
    friend drogon::orm::BaseBuilder<ProductTags, true, false>;
    friend drogon::orm::BaseBuilder<ProductTags, false, true>;
    friend drogon::orm::BaseBuilder<ProductTags, false, false>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<ProductTags>;
#endif
  ...
  public:
    ...
    {
        static const std::string sql="select * from " + tableName + " where product_id = $1 and tag_id = $2";
        return sql;
    }

    static const std::string &sqlForDeletingByPrimaryKey()
    {
        static const std::string sql="delete from " + tableName + " where product_id = $1 and tag_id = $2";
        return sql;
    }
